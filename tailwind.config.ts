  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        limited: {
          DEFAULT: "hsl(var(--limited))",
          foreground: "hsl(var(--limited-foreground))",
        },
        unavailable: {
      ...
      boxShadow: {
        ...
        'card-hover': '0 8px 30px -5px hsl(var(--primary) / 0.15)',
        'emergency': '0 0 50px -10px hsl(var(--emergency) / 0.5)',
      },
    },
  },
